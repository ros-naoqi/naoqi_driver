...
#ifndef OLD_CONCEPT_HPP
#define OLD_CONCEPT_HPP
...
public:
  ...
  */
  ...
  friend bool operator==( const Old& lhs, const Old& rhs )
  {
  ...
  friend bool operator==( const boost::shared_ptr<Old>& lhs, const boost::shared_ptr<Old>& rhs )
  {

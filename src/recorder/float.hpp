...
class FloatRecorder : public BaseRecorder<FloatRecorder>
{

public:
  FloatRecorder( const std::string& topic );

  void write( const std_msgs::Float32& msg );
